    ...
    public static String mostrarAyuda(String nombreTabla) {
        ...
        if (nombreTabla.equals("all")) {
            ...
            ayuda += "<!DOCTYPE html>\n"
                    ...
                    + "         <li>PRODUCTO</li>\n"
                    + "         <ul>\n"
                    + "             Adicionar Producto       =    A : {Producto,nombre,codigo,precio,costo,cantidad,administrador,pass administrador} <br>\n"
                    + "             Listar    Producto       =    L : {Producto,administrador,pass administrador}                   <br>\n"
                    + "             Modificar Producto       =    M : {Producto,id,nombre,codigo,precio,costo,cantidad,administrador,pass administrador}<br>\n"
                    + "             Eliminar  Producto       =    E : {Producto,id,administrador,pass administrador}<br>\n"
                    + "         </ul>\n"
                    + "\n"
                    ...
                    + "         <li>VENTA</li>\n"
                    + "         <ul>\n"
                    + "             Adicionar Venta       =    A : {Venta,idcliente,idproducto,cantidad,administrador,pass administrador} <br>\n"
                    + "         </ul>\n"
                    + "\n"
                    + "         <li>PAGO</li>\n"
                    + "         <ul>\n"
                    + "           Adicionar Pago   =  A : {Pago,total,idventa,administrador,pass administrador}<br>\n"
                    + "           Listar    Pago   =  L : {Pago,cliente,pass cliente}<br>\n"
                    + "           Modificar Pago   =  M : {Pago,id,total,idventa,administrador,pass administrador}<br>\n"
                    + "           Eliminar  Pago   =  E : {Pago,id,administrador,pass administrador}<br>\n"
                    + "         </ul>\n"
                    + "\n"
                    + "         <li>Reportes</li>\n"
                    + "         <ul>\n"
